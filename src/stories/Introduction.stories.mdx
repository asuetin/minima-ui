...
3. [Switch](/docs/components-switch--basic) - a button that allows the user to switch between "on" and "off" states;
4. [List](/docs/components-list--basic) - a basic virtualized list;
5. [ComboBox](/docs/components-combobox--basic) - a control allowing the user to search and select among a list of options.
