...
2. [List](/docs/components-list--basic) - a basic virtualized list;
3. [ComboBox](/docs/components-combobox--basic) - a control allowing the user to search and select among a list of options.
